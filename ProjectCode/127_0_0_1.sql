...
-- Χρόνος δημιουργίας: 31 Αυγ 2023 στις 17:10:11
...
('root', '[{\"db\":\"test_db\",\"table\":\"users\"},{\"db\":\"test_db\",\"table\":\"admins\"}]');
...
('root', 'test_db', 'users', '{\"sorted_col\":\"`users`.`email` ASC\"}', '2023-08-31 15:07:20');
...
('root', '2023-08-31 15:09:59', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"el\"}');
...
(1, 'Giannis', '123456789', ''),
(2, 'Nikos', 'Abcdef', ''),
(3, 'User1', 'User12345!', 'user@gmail.com');
