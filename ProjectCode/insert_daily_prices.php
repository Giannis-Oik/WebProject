<?php // Arxeio pou eisageis tis kathimerines times ton proionton
session_start();
include 'db_conn.php';
...
if(isset($_SESSION['id']) && isset($_SESSION['user_name']))
{
            ...
            if(move_uploaded_file($file_tmp, $upload_directory . $file_name))
            {
                ...
                if ($array === null && json_last_error() !== JSON_ERROR_NONE) {
                    ...
                    foreach($array as $row){
                        ...
                        $check_sql = "SELECT * FROM daily_prices WHERE  product_id = '$product_id' AND date = '$date' AND price = $price ";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            // SQL insert
                            $sql = "INSERT INTO daily_prices(product_id,date,price) VALUES ('$product_id','$date', '$price')";
    ...
    <html>
    <head>
        <title>Insert Daily Prices</title>
        <link rel="stylesheet" type="text/css" href="style.css">
    </head>
    <body>
        <div>
            <h1>Insert Daily Prices</h1>
